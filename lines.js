...
function getDString(divStart, divEnd) {
  ...
  const middle = {
    x:
      divStart.parentElement.offsetLeft +
      divStart.parentElement.offsetWidth / 2,
    y:
      divStart.parentElement.offsetTop +
      divStart.parentElement.offsetHeight / 2,
  };
  ...
  const dStr =
    ...
    " " +
    "Q" +
    getBezierQPoint(closestStartPoint, closestEndPoint, middle, radius) +
    closestEndPoint.x +
    "," +
    closestEndPoint.y;
  return dStr;
